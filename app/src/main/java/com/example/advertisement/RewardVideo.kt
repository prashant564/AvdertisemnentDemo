...
class RewardVideo : AppCompatActivity() {
            ...
            mRewardedAd.loadAd(
                ...
                object : RewardedAdLoadCallback() {
                    override fun onRewardedAdLoaded() {
                        mIsLoading = false
                        Toast.makeText(this@RewardVideo, "onRewardedAdLoaded", Toast.LENGTH_LONG).show()
                    }

                    override fun onRewardedAdFailedToLoad(errorCode: Int) {
                        mIsLoading = false
                        Toast.makeText(this@RewardVideo, "onRewardedAdFailedToLoad", Toast.LENGTH_LONG).show()
                    }
                }
            )
        }
            ...
            mRewardedAd.show(
                ...
                object : RewardedAdCallback() {
                    override fun onUserEarnedReward(
                        ...
                        Toast.makeText(this@RewardVideo, "onUserEarnedReward", Toast.LENGTH_LONG).show()
                        addCoins(rewardItem.amount)
                    }

                    override fun onRewardedAdClosed() {
                        Toast.makeText(this@RewardVideo, "onRewardedAdClosed", Toast.LENGTH_LONG).show()
                        loadRewardedAd()
                    }

                    override fun onRewardedAdFailedToShow(errorCode: Int) {
                        Toast.makeText(this@RewardVideo, "onRewardedAdFailedToShow", Toast.LENGTH_LONG).show()
                    }

                    override fun onRewardedAdOpened() {
                        Toast.makeText(this@RewardVideo, "onRewardedAdOpened", Toast.LENGTH_LONG).show()
                    }
                }
            )
        }
